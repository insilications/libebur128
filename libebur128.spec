...
cd %{_builddir}
mkdir -p ebu-loudness-test-setv05.tar
cd ebu-loudness-test-setv05.tar
tar xf %{_sourcedir}/ebu-loudness-test-setv05.tar.gz
cd %{_builddir}/libebur128
mkdir -p test/
cp -a %{_builddir}/ebu-loudness-test-setv05.tar/* %{_builddir}/libebur128/test/
